...
const ProjectsPage = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      date: t('projects.items.p4.date'),
      technologies: t('projects.items.p4.technologies'),
      color: 'from-orange-500 to-red-500',
    },
    {
      id: 5,
      title: t('projects.items.p5.title'),
      description: t('projects.items.p5.description'),
      date: t('projects.items.p5.date'),
      technologies: t('projects.items.p5.technologies'),
